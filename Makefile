...
LDFLAGS=-framework OpenAL -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo -g -std=c++11 -L/usr/local/lib -L/opt/local/lib -lglfw3 -lphosg
EXECUTABLES=mbes
